...
GOOGLE_CLIENT_ID=please_enter_your_google_client_id_here
GOOGLE_CLIENT_SECRET=please_enter_your_google_client_secret_here
MONGO_URI=please_enter_your_mongodb_uri_here

Note: Sensitive credentials are not included. Use a `.env.example` file as reference.  
